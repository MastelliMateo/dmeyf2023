...
for (i in 1:100) {
  ...
  PARAM$finalmodel$optim$num_iterations <- 9997
  PARAM$finalmodel$optim$learning_rate <- 0.020085
  PARAM$finalmodel$optim$feature_fraction <- 0.35855
  PARAM$finalmodel$optim$min_data_in_leaf <- 25130
