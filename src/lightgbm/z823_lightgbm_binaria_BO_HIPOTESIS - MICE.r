...
# Instala el paquete mice si aún no lo tienes instalado
...
PARAM$experimento <- "HT8216MMMICE"
...
PARAM$trainingstrategy$semilla_azar <- 100919

PARAM$hyperparametertuning$POS_ganancia <- 273000
PARAM$hyperparametertuning$NEG_ganancia <- -7000

# Aqui poner su segunda semilla
PARAM$lgb_semilla <- 101113
#------------------------------------------------------------------------------
...
dataset <- mice(dataset, 
                method = 'pmm',  # O puedes probar con otros métodos de imputación disponibles en mice
                m = 5,            # Número de imputaciones
                maxit = 50)       # Número máximo de iteraciones por imputación

# Combina las imputaciones en un solo conjunto de datos
