...
PARAM <- list()
PARAM$experimento <- "KA8240_baseline_exp_colab_caro"

PARAM$input$dataset <- "./datasets/competencia_03_caro.csv.gz"
...
for (i in 1:100) {
  ...
  PARAM$finalmodel$optim$num_iterations <- 9995
  PARAM$finalmodel$optim$learning_rate <- 0.020043
  PARAM$finalmodel$optim$feature_fraction <- 0.999333
  PARAM$finalmodel$optim$min_data_in_leaf <- 49988
  PARAM$finalmodel$optim$num_leaves <- 11
