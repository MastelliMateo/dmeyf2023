...
for (i in 1:100) {
  ...
  PARAM$finalmodel$optim$num_iterations <- 9993
  PARAM$finalmodel$optim$learning_rate <- 0.0275
  PARAM$finalmodel$optim$feature_fraction <- 0.3470
  PARAM$finalmodel$optim$min_data_in_leaf <- 27501
  PARAM$finalmodel$optim$num_leaves <- 363
